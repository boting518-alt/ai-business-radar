...
describe("MVP route shells",()=>{it.each([[Radar,"AI 商业机会雷达"],[Opportunities,"机会库"],[Signals,"商业信号"],[Watchlist,"Watchlist"],[Reviews,"人工审核 Review"]] as const)("renders its page heading",(Page,title)=>{render(<Page/>);expect(screen.getByRole("heading",{name:title})).toBeInTheDocument()})});

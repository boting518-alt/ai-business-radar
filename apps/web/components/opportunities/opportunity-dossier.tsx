...
function PrimaryMetric({label,value,definition}:{label:string;value:string|null|undefined;definition:string}){return <div className="p-4" title={definition}><p className="text-xs text-slate-500">{label}</p><p className="mt-2 text-3xl font-semibold tabular-nums">{display(value)}</p><p className="mt-1 text-[11px] text-slate-400">{definition}</p></div>}

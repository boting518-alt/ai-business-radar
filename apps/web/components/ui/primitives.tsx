...
export function ScoreBadge({label,value}:{label:string;value:number|null}){return <span className="rounded border px-2 py-1 text-xs tabular-nums">{label} {value==null?"—":value}</span>}

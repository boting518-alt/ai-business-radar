...
const enumLabels: Record<Locale, Record<string,string>> = {
  "zh-CN": {current:"当前有效",under_review:"语义待审核",invalid_semantic:"语义无效",superseded:"已被替代",buyer:"买方",seller_vendor:"卖方／供应商",creator_channel:"创作者／频道",affiliate_referrer:"联盟推广者",platform_marketplace:"平台／市场",featured_product_company:"所述产品／公司",buyer_expression:"买方表达",seller_cta:"卖方行动号召",seller_claim:"卖方声明",creator_monetization:"创作者变现",product_monetization:"产品变现",product_pricing:"产品定价",observed_transaction:"交易／使用声明",third_party_observation:"第三方观察",supporting:"支持",contradicting:"反对",context:"背景",candidate_match:"候选匹配",workflow:"工作流",technology:"技术",pain:"痛点",demand:"需求",pricing:"定价",purchase_intent:"购买意向",feature_request:"功能请求",complaint:"投诉",competition:"竞争",revenue:"营收",customer:"客户",product_launch:"产品发布",growth:"增长",distribution:"分销",market_change:"市场变化",adoption:"采用",fact:"事实",creator_claim:"创作者声明",inferred:"推断",opinion:"观点",speculation:"推测",unknown:"未知",candidate:"候选",active:"已发布",publish:"发布",defer:"暂缓",invalid:"无效",video:"YouTube 视频",comment:"YouTube 评论",youtube_video:"YouTube 视频",youtube_comment:"YouTube 评论",manual:"人工证据",market_context:"市场背景"},
  "en-US": {current:"Current",under_review:"Semantic review required",invalid_semantic:"Semantically invalid",superseded:"Superseded",buyer:"Buyer",seller_vendor:"Seller / vendor",creator_channel:"Creator / channel",affiliate_referrer:"Affiliate / referrer",platform_marketplace:"Platform / marketplace",featured_product_company:"Named product / company",buyer_expression:"Buyer expression",seller_cta:"Seller CTA",seller_claim:"Seller claim",creator_monetization:"Creator monetization",product_monetization:"Product monetization",product_pricing:"Product pricing",observed_transaction:"Transaction / use claim",third_party_observation:"Third-party observation",supporting:"Supporting",contradicting:"Contradicting",context:"Context",candidate_match:"Candidate match",workflow:"Workflow",technology:"Technology",pain:"Pain",demand:"Demand",pricing:"Pricing",purchase_intent:"Purchase intent",feature_request:"Feature request",complaint:"Complaint",competition:"Competition",revenue:"Revenue",customer:"Customer",product_launch:"Product launch",growth:"Growth",distribution:"Distribution",market_change:"Market change",adoption:"Adoption",fact:"Fact",creator_claim:"Creator claim",inferred:"Inferred",opinion:"Opinion",speculation:"Speculation",unknown:"Unknown",candidate:"Candidate",active:"Active",publish:"Publish",defer:"Defer",invalid:"Invalid",video:"YouTube Video",comment:"YouTube Comment",youtube_video:"YouTube Video",youtube_comment:"YouTube Comment",manual:"Manual evidence",market_context:"Market context"},
};
